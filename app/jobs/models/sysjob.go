...
type SysJob struct {
	...
	JobType        int64  `json:"jobType" gorm:"size:1;"`                // 任务类型
	...
	MisfirePolicy  int64  `json:"misfirePolicy" gorm:"size:255;"`        // 执行策略
	Concurrent     int64  `json:"concurrent" gorm:"size:1;"`             // 是否并发
	Status         int64  `json:"status" gorm:"size:1;"`                 // 状态
	EntryId        int    `json:"entryId" gorm:"size:11;"`               // job启动时返回的id
	models.ControlBy
	models.ModelTime
...
func (e *SysJob) SetCreateBy(createBy int64) {
	e.CreateBy = createBy
}

func (e *SysJob) SetUpdateBy(updateBy int64) {
	e.UpdateBy = updateBy
}
