...
type RcI18nContentGetPageReq struct {
	...
	ProcessedId int64  `form:"processedId"  search:"type:exact;column:processed_id;table:rc_ixxn_content" comment:"rc_processed_content.id"`
...
type RcI18nContentGetResp struct {
	Id          int64  `json:"id"`          // 主键
	ProcessedId int64  `json:"processedId"` // rc_processed_content.id
...
type RcI18nContentExport struct {
	...
	ProcessedId int64  `json:"processedId" gorm:"comment:rc_processed_content.id" xlsx:"rc_processed_content.id"`
