...
// RcTradesDetail 客户、供应商交易细节（来自origin_content表)
...
func (*RcTradesDetail) TableName() string {
	return "rc_trades_detail"
}

func (e *RcTradesDetail) Generate() models.ActiveRecord {
	o := *e
	return &o
}

func (e *RcTradesDetail) GetId() interface{} {
	return e.Id
}
