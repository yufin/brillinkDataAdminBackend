...
type RcDependencyDataGetPageReq struct {
	...
	ContentId int64  `form:"contentId"  search:"type:exact;column:content_id;table:rc_dependency_data" comment:"rskc_origin_content.id"`
...
type RcDependencyDataGetResp struct {
	Id        int64  `json:"id"`        // 主键
	ContentId int64  `json:"contentId"` // rskc_origin_content.id
