...
func sysNoCheckRoleRouter(v1 *gin.RouterGroup, authMiddleware *jwtauth.GinJWTMiddleware) {
	r1 := v1.Group("")
	{
		sys := apis.System{}
...
func registerDBRouter(v1 *gin.RouterGroup, authMiddleware *jwtauth.GinJWTMiddleware) {
...
func registerSysTableRouter(v1 *gin.RouterGroup, authMiddleware *jwtauth.GinJWTMiddleware) {
