...
// CGO_ENABLED=0 GOOS=windows GOARCH=amd64 go build -o bin/bl-data-admin-win-amd64.exe main.go
// CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o bin/bl-data-admin-linux-amd64 main.go
