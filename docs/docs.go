...
const docTemplate = `{
    ...
    "paths": {
                                                ...
                                                },
                                                {
                                                    ...
                                                    "properties": {
                                                        "list": {
                                                            "type": "array",
                                                            "items": {
                                                                "$ref": "#/definitions/models.EnterpriseWaitList"
                                                            }
                                                        }
                                                    }
                                                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.EnterpriseWaitListInsertReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/enterprise-wait-list/{id}": {
            "get": {
                "security": [
                    {
                        "Bearer": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.EnterpriseWaitListUpdateReq"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "antd.Pages": {
            ...
            "properties": {
                ...
                "host": {
                    "description": "onvenient for backend Troubleshooting: host of current access server",
                    "type": "string"
                },
                "pageSize": {
                    "type": "integer"
        ...
        "dto.EnterpriseWaitListInsertReq": {
            "type": "object",
            "properties": {
                "createBy": {
                    "type": "integer"
        ...
        "dto.EnterpriseWaitListUpdateReq": {
            "type": "object",
            "properties": {
                "createBy": {
                    "type": "integer"
